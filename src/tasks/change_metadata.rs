...
use fake::{faker::{internet::en::{FreeEmail, Username}, lorem::en::Words}, Fake};
...
impl TaskParam for TxChangeMetadataParameters {
    ...
    fn from_dto(dto: Self::D, state: &Storage) -> Self {
        let source = match dto.source {
            ...
            Value::Fuzz { value } => unimplemented!(),
        };
        ...
        let commission_rate = match dto.commission_rate {
            ...
            Some(Value::Fuzz { .. }) => {
                rand::thread_rng().gen_range(1..100) as u64
            },
            _ => 0
        };

        Self { source, email, avatar, description, discord_handle, website, commission_rate }
    }
}
